...
This project was developed collaboratively. For questions or contributions, please open an issue or a pull request on the repository.

## 🙏 Acknowledgements

We would like to express our gratitude to:
- The agricultural research community for valuable insights
- Farmers who provided domain knowledge
- Open source community for amazing tools and libraries
- Dataset contributors

## 📞 Support

For inquiries or support, please open an issue on the project's repository (use the Issues tab) so maintainers can track and respond to requests.
